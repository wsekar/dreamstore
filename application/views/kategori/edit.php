                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="<?= base_url('kategori/proses_edit/' . $kategori->id_kategori) ?>" id="form-tambah"
                                        method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="kode_kategori"
                                                    ...
                                                    value="<?= $kategori->kode_kategori ?>" maxlength="8" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Nama Kategori</label>
                                                <input type="text" name="nama_kategori"
                                                    placeholder="Masukkan Nama Kategori" autocomplete="off"
                                                    class="form-control" required value="<?= $kategori->nama_kategori ?>">
                                            </div>
                                        </div>
